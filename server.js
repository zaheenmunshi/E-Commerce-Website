...
let serviceAccount = require("./bilal-s-mens-wear-ecom-website-firebase-adminsdk-dlbcs-c1aa5c7853.json");
...
const bucketName = "ecom-website404";
...
app.get('/s3url', (req, res) => {
    genrateUrl().then(url => res.json(url));
})
...
// 404 route
app.get('/404', (req, res) => {
    res.sendFile(path.joinn(staticPath, "404.html"));
})
